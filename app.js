...
// The Superhero List Class Function
class SuperheroList {
    // Add Superhero
    addSuperhero(entry) {
    ...
    //Clear Superhero Input Field Function
    ...
    validationError() {
        ...
        setTimeout(() => {
            document.querySelector(".validate-error")
    ...
    validationSuccess() {
        ...
        setTimeout(() => {
            document.querySelector(".validate-success")
            .classList.remove("show-validation")
        }, 1500);
    }
}
...
form.addEventListener('submit', function(e) {
    ...
    //Validate the form if one or more of the input field are emty
    if(
        superheroName === "" ||
        superheroUniverse === "" ||
        superheroPower === ""
